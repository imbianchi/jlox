...
## Table of Contents
- [Java Interpreter (jlox)](#java-interpreter-jlox)
...
2. Navigate to lox project directory: `cd jlox/`
3. Build the solution: `javac -d out com/craftinginterpreters/lox/*.java`
4. Run the interpreter: `java -cp out com.craftinginterpreters.lox.Lox` or `java -cp out com.craftinginterpreters.lox.Lox testFile.lox`
